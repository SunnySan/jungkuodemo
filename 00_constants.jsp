...
public static final String	gcLogFilePath							= "/var/log/vmallhtml/";	//寫入系統Log檔的路徑(writeToFile()使用)
public static final String	gcBasePathForFileUpload					= "/VTube/VShopUpload/vmallhtml/";	//預設檔案上傳路徑
public static final String	gcURLForUploadedFile					= "https://vshop.vibo.com.tw/vshopupload/vmallhtml/";	//瀏覽圖檔的URL
...
//public static final String	gcDefaultEmailFromAddress				= "vshopservice@vibo.com.tw";	//發送email的發信人email address
public static final String	gcDefaultEmailFromAddress				= "vshopadmin@vibo.com.tw";	//發送email的發信人email address
public static final String	gcDefaultEmailFromName					= "VMall Portal 管理系統";	//發送email的發信人名稱
